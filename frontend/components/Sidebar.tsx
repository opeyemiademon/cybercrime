        ...
        <div className="flex flex-col h-full">
          <div className="p-6 border-b border-primary-700 relative">
            <div className={`flex items-center ${isCollapsed ? 'justify-center' : 'space-x-3'}`}>
              ...
              {!isCollapsed && (
                <div>
                  <h1 className="text-lg font-bold">Evidence System</h1>
                  <p className="text-xs text-primary-200">Chain of Custody</p>
                </div>
              )}
            </div>
            <button
          ...
          <div className="p-4 border-t border-primary-700">
            {!isCollapsed ? (
              <>
                ...
                <button className="flex items-center space-x-3 px-4 py-2 w-full text-primary-100 hover:bg-primary-700 rounded-lg transition-colors">
