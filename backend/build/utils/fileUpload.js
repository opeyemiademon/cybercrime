...
export const ensureDirectoriesExist = (customDir) => {
 ...
 */
export const processEvidenceUpload = async (base64Data, caseId, originalFilename, evidenceId) => {
 ...
 * @returns Object with filename and file path
 */
export const processEvidenceFileUpload = async (file, caseId, evidenceId) => {
    const caseDir = `case_${caseId}`;
    ensureDirectoriesExist(caseDir);
    try {
